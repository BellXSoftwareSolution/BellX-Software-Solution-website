const FeedbackCard = ({ content, name, title, img }) => (
  <div className="flex justify-between  flex-col  lg:px-10 py-12 rounded-[20px] w-full lg:w-[70%]  mx-auto my-0 feedback-card  ">
    ...
    />
    <p className="font-poppins font-normal tex-[15px] font-light lg:text-[18px] italic leading-[32.4px] my-10">
      {content}
    </p>
